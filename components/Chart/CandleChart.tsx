...
//         <CardDescription>Real-time price updates from Binance (1-second throttle)</CardDescription>
//       </CardHeader>
...
//                 domain={[
//                   (dataMin: number) =>
//                     Math.min(...chartData.slice(-10).map((d) => d.price)) - 1,
//                   (dataMax: number) =>
//                     Math.max(...chartData.slice(-10).map((d) => d.price)) + 1,
//                 ]}
//                 tickLine={false}
//                 axisLine={false}
//                 tickMargin={8}
